...
model = load_model(path=os.path.join(model_dir, 'Bi2Te3.pth'))

data_dir = os.path.join(parent_dir, "data")
csv_file = os.path.join(data_dir, "Bi2Te3.csv")

_, _, stats, _ = load_dataset_from_csv(csv_file)

property_dir = os.path.join(parent_dir, "property")
material_csv = os.path.join(property_dir, "Bi2Te3_property.csv") 
...
export_current_scan_csv('I_scan_Bi2Te3_Th_573.csv', I_list, V_list, q_list, P_list, efficiency_list)
...
export_temperature_scan_csv('T_scan_Bi2Te3.csv', Th_valid, P_max_list, eff_max_list)
